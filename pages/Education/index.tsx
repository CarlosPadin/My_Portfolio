...
const STUDIES = [
  ...
  {
    name: "Diagnostic Ultrasound Systems (Severeal Courses)",
    company_name: "Center for Clinic Engineering and Electromedicine",
    graduation_date: "03/09/2022",
    logo: "/img/JobsLogos/CNE.png",
    skills: ["Diagnostic Ultrasound APLIO-300", "Diagnostic Ultrasound CX-50, CX-100"],
  },
  {
    name: "X-Rays Systems",
    company_name: "Center for Clinic Engineering and Electromedicine",
    graduation_date: "10/05/2022",
    logo: "/img/JobsLogos/CNE.png",
    skills: ["Movil X-Rays SHIMADZU MX8c"],
  },
  {
    name: "Hematological Systems",
    company_name: "Center for Clinic Engineering and Electromedicine",
    graduation_date: "04/04/2022",
    logo: "/img/JobsLogos/CNE.png",
